        ...
        >
          <MenuOptionGroup w="50%">
            <MenuItem _hover={{ bg: "white" }}>
              <Link to="/groceries"> Fruits &amp; Vegetables</Link>
            </MenuItem>
      ...
      <>
        ...
        >
          <MenuOptionGroup w="50%">
            ...
            <MenuItem _hover={{ bg: "white" }}>Citrus, Mango & Grapes</MenuItem>
          </MenuOptionGroup>
          <Center w={2}>
            <Divider orientation="vertical" w={"1px"} bg="grey" />
          </Center>
      ...
      <>
        ...
        >
          <MenuOptionGroup w="50%">
            ...
            <MenuItem _hover={{ bg: "white" }}>Toys, Games & Fitness</MenuItem>
          ...
          <MenuOptionGroup w="50%">
            <MenuItem _hover={{ bg: "white" }}>Bags & Travel Luggage</MenuItem>
            <MenuItem _hover={{ bg: "white" }}>Mops, Brushes & Scrubs</MenuItem>
    ...
    <Menu isOpen={isOpen}>
      <>
        ...
        >
          ...
          <MenuItem _hover={{ bg: "white" }}>Personal Care & Grooming</MenuItem>
